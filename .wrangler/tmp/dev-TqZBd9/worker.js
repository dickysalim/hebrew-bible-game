...
__name(handleLexicon, "handleLexicon");
...
__name(handleAllRoots, "handleAllRoots");
...
__name(handleLemma, "handleLemma");
...
__name(handleRootDef, "handleRootDef");
...
__name(handleLemmaBatch, "handleLemmaBatch");
...
async function handleHaber(request, env) {
  ...
  const apiMessages = !messages || messages.length === 0 ? [{ role: "user", content: "." }] : messages;
...
__name(handleHaber, "handleHaber");
...
// .wrangler/tmp/bundle-uxKrCE/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-uxKrCE/middleware-loader.entry.ts
