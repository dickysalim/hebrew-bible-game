// Test script for search functionality with correct data structure
...
console.log('Testing search functionality with fixed data structure...\n');
...
const results1 = searchRoots(mockRootsArray, 'create');
...
const results2 = searchRoots(mockRootsArray, 'earth');
...
const results3 = searchRoots(mockRootsArray, 'ברא');
...
const results4 = searchRoots(mockRootsArray, 'bara');
...
const results5 = searchRoots(mockRootsArray, 'H1254');
