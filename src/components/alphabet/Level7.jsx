...
/**
 * Level 7 intro — one-time screen before the streak begins.
...
/**
 * Level 7 — SBL Sound → Type Symbol (27-streak)
 *
 ...
 */
export default function Level7({ onComplete, onBack }) {
    ...
    return (
      <div className="alphabet-level-screen">
        <div className="level-complete-card">
          ...
          <h2 className="level-complete-title">Level 7 Complete!</h2>
    ...
    <>
      <div className="level-header">
        ...
        <div className="level-header-title">
          <span className="level-tag">Level 7</span>
